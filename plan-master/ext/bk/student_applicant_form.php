...
?>
                ...
                <span title="add new community" style="color:blue;cursor:pointer;text-decoration:underline" onclick="addCommunity()">add</span></td>
	</tr>
<?php } ?>
...
Age :<input type="text" size="2" onchange="calcualteBirthDate()" id="txtAge">
