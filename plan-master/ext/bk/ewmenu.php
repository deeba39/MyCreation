...
$RootMenu->AddMenuItem(14, $Language->MenuPhrase("14", "MenuText"), "student_applicantlist.php", 66, "", AllowListMenu('student_applicant'));
...
$RootMenu->AddMenuItem(46, $Language->MenuPhrase("46", "MenuText"), "student_applicantadd.php", 66, "", IsLoggedIn());
$RootMenu->AddMenuItem(67, $Language->MenuPhrase("67", "MenuText"), "", -1, "", IsLoggedIn());
$RootMenu->AddMenuItem(13, $Language->MenuPhrase("13", "MenuText"), "sponsored_studentlist.php", 67, "", AllowListMenu('sponsored_student'));
...
$RootMenu->AddMenuItem(104, $Language->MenuPhrase("104", "MenuText"), "payment_requestlist.php", 28, "", AllowListMenu('Payment_Requests'));
...
$RootMenu->AddMenuItem(59, $Language->MenuPhrase("59", "MenuText"), "AllPaymentRecordslist.php", 28, "", AllowListMenu('AllPaymentRecords'));
