...
$Disburse_Payments = NULL;

//
// Table class for Disburse Payments
//
class cDisburse_Payments {
	var $TableVar = 'Disburse_Payments';
	...
	//
	function cDisburse_Payments() {
		global $Language;

		// payment_request_id
		$this->payment_request_id = new cField('Disburse_Payments', 'Disburse Payments', 'x_payment_request_id', 'payment_request_id', '`payment_request_id`', 3, -1, FALSE, '`payment_request_id`', FALSE);
		...
		// code
		$this->code = new cField('Disburse_Payments', 'Disburse Payments', 'x_code', 'code', '`code`', 200, -1, FALSE, '`code`', FALSE);
		$this->fields['code'] =& $this->code;

		// programarea_id
		$this->programarea_id = new cField('Disburse_Payments', 'Disburse Payments', 'x_programarea_id', 'programarea_id', '`programarea_id`', 3, -1, FALSE, '`programarea_id`', FALSE);
		$this->programarea_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['programarea_id'] =& $this->programarea_id;

		// year
		$this->year = new cField('Disburse_Payments', 'Disburse Payments', 'x_year', 'year', '`year`', 18, -1, FALSE, '`year`', FALSE);
		$this->year->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['year'] =& $this->year;

		// request_date
		$this->request_date = new cField('Disburse_Payments', 'Disburse Payments', 'x_request_date', 'request_date', '`request_date`', 133, 7, FALSE, '`request_date`', FALSE);
		...
		// request_status
		$this->request_status = new cField('Disburse_Payments', 'Disburse Payments', 'x_request_status', 'request_status', '`request_status`', 202, -1, FALSE, '`request_status`', FALSE);
		$this->fields['request_status'] =& $this->request_status;

		// financial_year_financial_year_id
		$this->financial_year_financial_year_id = new cField('Disburse_Payments', 'Disburse Payments', 'x_financial_year_financial_year_id', 'financial_year_financial_year_id', '`financial_year_financial_year_id`', 3, -1, FALSE, '`financial_year_financial_year_id`', FALSE);
		...
		// amount
		$this->amount = new cField('Disburse_Payments', 'Disburse Payments', 'x_amount', 'amount', '`amount`', 3, -1, FALSE, '`amount`', FALSE);
		$this->amount->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['amount'] =& $this->amount;

		// group_id
		$this->group_id = new cField('Disburse_Payments', 'Disburse Payments', 'x_group_id', 'group_id', '`group_id`', 3, -1, FALSE, '`group_id`', FALSE);
	...
	function HighlightName() {
		return "Disburse_Payments_Highlight";
	}
	...
	function SqlSelect() { // Select
		return "SELECT payment_request.* FROM " . $this->SqlFrom();
	}
	...
	function SqlKeyFilter() {
		return "`payment_request_id` = @payment_request_id@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "Disburse_Paymentslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("Disburse_Paymentsview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "Disburse_Paymentsadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("Disburse_Paymentsedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("Disburse_Paymentsadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("Disburse_Paymentsdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=Disburse_Payments" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
