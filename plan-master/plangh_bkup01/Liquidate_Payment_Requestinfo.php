...
class cLiquidate_Payment_Request {
	...
	function cLiquidate_Payment_Request() {
		...
		// payment_request_id
		$this->payment_request_id = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_payment_request_id', 'payment_request_id', '`payment_request_id`', 3, -1, FALSE, '`payment_request_id`', FALSE);
		...
		// year
		$this->year = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_year', 'year', '`year`', 18, -1, FALSE, '`year`', FALSE);
		$this->year->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['year'] =& $this->year;

		// request_date
		$this->request_date = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_request_date', 'request_date', '`request_date`', 133, 7, FALSE, '`request_date`', FALSE);
		...
		// programarea_id
		$this->programarea_id = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_programarea_id', 'programarea_id', '`programarea_id`', 3, -1, FALSE, '`programarea_id`', FALSE);
		$this->programarea_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['programarea_id'] =& $this->programarea_id;

		// request_status
		$this->request_status = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_request_status', 'request_status', '`request_status`', 202, -1, FALSE, '`request_status`', FALSE);
		$this->fields['request_status'] =& $this->request_status;

		// code
		$this->code = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_code', 'code', '`code`', 200, -1, FALSE, '`code`', FALSE);
		$this->fields['code'] =& $this->code;

		// financial_year_financial_year_id
		$this->financial_year_financial_year_id = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_financial_year_financial_year_id', 'financial_year_financial_year_id', '`financial_year_financial_year_id`', 3, -1, FALSE, '`financial_year_financial_year_id`', FALSE);
		...
		// amount
		$this->amount = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_amount', 'amount', '`amount`', 3, -1, FALSE, '`amount`', FALSE);
		$this->amount->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['amount'] =& $this->amount;

		// group_id
		$this->group_id = new cField('Liquidate_Payment_Request', 'Liquidate Payment Request', 'x_group_id', 'group_id', '`group_id`', 3, -1, FALSE, '`group_id`', FALSE);
