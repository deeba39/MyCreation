...
class csponsored_student_detail {
	...
	function csponsored_student_detail() {
		...
		$this->community_community_id = new cField('sponsored_student_detail', 'sponsored_student_detail', 'x_community_community_id', 'community_community_id', 'student_applicant.community_community_id', 3, -1, FALSE, 'student_applicant.community_community_id', FALSE);
	...
	function SqlFrom() { // From
		return "sponsored_student Inner Join student_applicant On sponsored_student.student_applicant_student_applicant_id = student_applicant.student_applicant_id";
	}

	function SqlSelect() { // Select
		return "SELECT sponsored_student.student_firstname, sponsored_student.student_middlename, sponsored_student.student_lastname, sponsored_student.student_resident_programarea_id, student_applicant.student_telephone_1, student_applicant.student_telephone_2, student_applicant.student_dob, student_applicant.community_community_id, student_applicant.app_submission_year, student_applicant.student_gender, student_applicant.student_address, sponsored_student.sponsored_student_id FROM " . $this->SqlFrom();
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO sponsored_student Inner Join student_applicant On sponsored_student.student_applicant_student_applicant_id = student_applicant.student_applicant_id ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE sponsored_student Inner Join student_applicant On sponsored_student.student_applicant_student_applicant_id = student_applicant.student_applicant_id SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM sponsored_student Inner Join student_applicant On sponsored_student.student_applicant_student_applicant_id = student_applicant.student_applicant_id WHERE ";
   ...
   // Common render codes
		...
		// student_telephone_1
		$this->student_telephone_1->CellCssStyle = ""; $this->student_telephone_1->CellCssClass = "";
		...
		// student_telephone_2
		$this->student_telephone_2->CellCssStyle = ""; $this->student_telephone_2->CellCssClass = "";
		...
		// student_address
		$this->student_address->CellCssStyle = ""; $this->student_address->CellCssClass = "";
		...
		if (strval($this->app_submission_year->CurrentValue) <> "") {
			switch ($this->app_submission_year->CurrentValue) {
				case "2011":
					$this->app_submission_year->ViewValue = "2011";
					break;
				case "2010":
					$this->app_submission_year->ViewValue = "2010";
					break;
				default:
	...
	function Row_Updating(&$rsold, &$rsnew) {
		...
		// Enter your code here
		//if the user's prgram area is different from student, dont update
