...
class cview_sponsored_student_grant_package {
	...
	function cview_sponsored_student_grant_package() {
		...
		// start_date
		$this->start_date = new cField('view_sponsored_student_grant_package', 'view_sponsored_student_grant_package', 'x_start_date', 'start_date', 'scholarship_package.start_date', 135, 7, FALSE, 'scholarship_package.start_date', FALSE);
		$this->start_date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['start_date'] =& $this->start_date;

		// end_date
		$this->end_date = new cField('view_sponsored_student_grant_package', 'view_sponsored_student_grant_package', 'x_end_date', 'end_date', 'scholarship_package.end_date', 135, 7, FALSE, 'scholarship_package.end_date', FALSE);
