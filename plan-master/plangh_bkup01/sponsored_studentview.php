...
<?php if ($sponsored_student->student_picture->Visible) { // student_picture ?>
	<tr<?php echo $sponsored_student->RowAttributes() ?>>
		...
		<td<?php echo $sponsored_student->student_picture->CellAttributes() ?>>
...
<div<?php echo $sponsored_student->student_grades->ViewAttributes() ?>><?php echo $sponsored_student->student_grades->ViewValue ?></div></td>
	</tr>
<?php } ?>
