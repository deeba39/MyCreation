...
define("EW_PROJECT_NAME", "PlanGhana", TRUE); // Project name
define("EW_RANDOM_KEY", 'X82GSTch9DEQtJg2', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "PlanGhana.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'plangh', TRUE);
define("EW_CONN_PASS", 'BSRWR8Z3@xBO', TRUE);
define("EW_CONN_DB", 'plangh_user', TRUE);
...
define("EW_ADMIN_PASSWORD", "pass", TRUE); // Administrator password
...
$EW_USER_LEVEL_TABLE_NAME[] = 'programarea';
$EW_USER_LEVEL_TABLE_VAR[] = 'programarea';
$EW_USER_LEVEL_TABLE_NAME[] = 'sponsored_student';
$EW_USER_LEVEL_TABLE_VAR[] = 'sponsored_student';
$EW_USER_LEVEL_TABLE_NAME[] = 'student_applicant';
$EW_USER_LEVEL_TABLE_VAR[] = 'student_applicant';
$EW_USER_LEVEL_TABLE_NAME[] = 'applicant_school';
$EW_USER_LEVEL_TABLE_VAR[] = 'applicant_school';
$EW_USER_LEVEL_TABLE_NAME[] = 'application_occupation';
$EW_USER_LEVEL_TABLE_VAR[] = 'application_occupation';
$EW_USER_LEVEL_TABLE_NAME[] = 'community';
$EW_USER_LEVEL_TABLE_VAR[] = 'community';
$EW_USER_LEVEL_TABLE_NAME[] = 'grade_subject';
$EW_USER_LEVEL_TABLE_VAR[] = 'grade_subject';
$EW_USER_LEVEL_TABLE_NAME[] = 'grade_year';
$EW_USER_LEVEL_TABLE_VAR[] = 'grade_year';
$EW_USER_LEVEL_TABLE_NAME[] = 'grant_package';
$EW_USER_LEVEL_TABLE_VAR[] = 'grant_package';
$EW_USER_LEVEL_TABLE_NAME[] = 'scholarship_package';
$EW_USER_LEVEL_TABLE_VAR[] = 'scholarship_package';
$EW_USER_LEVEL_TABLE_NAME[] = 'scholarship_payment';
$EW_USER_LEVEL_TABLE_VAR[] = 'scholarship_payment';
$EW_USER_LEVEL_TABLE_NAME[] = 'school_attendance';
$EW_USER_LEVEL_TABLE_VAR[] = 'school_attendance';
$EW_USER_LEVEL_TABLE_NAME[] = 'school_type';
$EW_USER_LEVEL_TABLE_VAR[] = 'school_type';
$EW_USER_LEVEL_TABLE_NAME[] = 'schools';
$EW_USER_LEVEL_TABLE_VAR[] = 'schools';
$EW_USER_LEVEL_TABLE_NAME[] = 'districts';
$EW_USER_LEVEL_TABLE_VAR[] = 'districts';
$EW_USER_LEVEL_TABLE_NAME[] = 'regions';
$EW_USER_LEVEL_TABLE_VAR[] = 'regions';
$EW_USER_LEVEL_TABLE_NAME[] = 'users';
$EW_USER_LEVEL_TABLE_VAR[] = 'users';
$EW_USER_LEVEL_TABLE_NAME[] = 'application_status';
$EW_USER_LEVEL_TABLE_VAR[] = 'application_status';
$EW_USER_LEVEL_TABLE_NAME[] = 'payment_request';
$EW_USER_LEVEL_TABLE_VAR[] = 'payment_request';
$EW_USER_LEVEL_TABLE_NAME[] = 'financial_year';
$EW_USER_LEVEL_TABLE_VAR[] = 'financial_year';
$EW_USER_LEVEL_TABLE_NAME[] = 'scholarship_type';
$EW_USER_LEVEL_TABLE_VAR[] = 'scholarship_type';
$EW_USER_LEVEL_TABLE_NAME[] = 'selection_grade_point';
$EW_USER_LEVEL_TABLE_VAR[] = 'selection_grade_point';
$EW_USER_LEVEL_TABLE_NAME[] = 'audittrail';
$EW_USER_LEVEL_TABLE_VAR[] = 'audittrail';
$EW_USER_LEVEL_TABLE_NAME[] = 'logs';
$EW_USER_LEVEL_TABLE_VAR[] = 'logs';
$EW_USER_LEVEL_TABLE_NAME[] = 'Disburse Payments';
$EW_USER_LEVEL_TABLE_VAR[] = 'Disburse_Payments';
$EW_USER_LEVEL_TABLE_NAME[] = 'Payment Refund';
$EW_USER_LEVEL_TABLE_VAR[] = 'Payment_Refund';
$EW_USER_LEVEL_TABLE_NAME[] = 'Liquidate Payment Request';
$EW_USER_LEVEL_TABLE_VAR[] = 'Liquidate_Payment_Request';
$EW_USER_LEVEL_TABLE_NAME[] = 'New_Payment_Requests';
$EW_USER_LEVEL_TABLE_VAR[] = 'New_Payment_Requests';
$EW_USER_LEVEL_TABLE_NAME[] = 'rptRefunds';
$EW_USER_LEVEL_TABLE_VAR[] = 'rptRefunds';
$EW_USER_LEVEL_TABLE_NAME[] = 'rptRefunds_SponsoredStudent';
$EW_USER_LEVEL_TABLE_VAR[] = 'rptRefunds_SponsoredStudent';
$EW_USER_LEVEL_TABLE_NAME[] = 'rptPaymentReportBySchool';
$EW_USER_LEVEL_TABLE_VAR[] = 'rptPaymentReportBySchool';
$EW_USER_LEVEL_TABLE_NAME[] = 'SelectionView';
$EW_USER_LEVEL_TABLE_VAR[] = 'SelectionView';
$EW_USER_LEVEL_TABLE_NAME[] = 'AppConfirmView';
$EW_USER_LEVEL_TABLE_VAR[] = 'AppConfirmView';
$EW_USER_LEVEL_TABLE_NAME[] = 'sponsored_student_detail';
$EW_USER_LEVEL_TABLE_VAR[] = 'sponsored_student_detail';
$EW_USER_LEVEL_TABLE_NAME[] = 'Refund Amounts';
$EW_USER_LEVEL_TABLE_VAR[] = 'Refund_Amounts';
$EW_USER_LEVEL_TABLE_NAME[] = 'Refunds To Students';
$EW_USER_LEVEL_TABLE_VAR[] = 'Refunds_To_Students';
$EW_USER_LEVEL_TABLE_NAME[] = 'Refunds by School';
$EW_USER_LEVEL_TABLE_VAR[] = 'Refunds_by_School';
for ($i = 0; $i < 37; $i++)
...
define("EW_USER_ID_FILTER", "(`userlevelid` = %u)",  TRUE);
