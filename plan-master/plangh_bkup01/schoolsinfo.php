...
class cschools {
	...
	function cschools() {
		...
		$this->community_community_id = new cField('schools', 'schools', 'x_community_community_id', 'community_community_id', '`community_community_id`', 3, -1, FALSE, '`community_community_id`', FALSE);
	...
	function SqlDetailFilter_community() {
		return "`community_community_id`=@community_community_id@";
	}
