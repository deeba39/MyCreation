...
<?php if ($view_sponsored_student_grant_package->end_date->Visible) { // end_date ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->Visible) { // sponsored_student_sponsored_student_id ?>
	<?php if ($view_sponsored_student_grant_package->SortUrl($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id) == "") { ?>
		<td><?php echo $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $view_sponsored_student_grant_package->SortUrl($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->FldCaption() ?></td><td style="width: 10px;"><?php if ($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<div<?php echo $view_sponsored_student_grant_package->end_date->ViewAttributes() ?>><?php echo $view_sponsored_student_grant_package->end_date->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->Visible) { // sponsored_student_sponsored_student_id ?>
		<td<?php echo $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->CellAttributes() ?>>
<div<?php echo $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->ViewAttributes() ?>><?php echo $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($view_sponsored_student_grant_package->scholarship_type_scholarship_type->Visible) { // scholarship_type_scholarship_type ?>
...
class cview_sponsored_student_grant_package_list {
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$view_sponsored_student_grant_package->UpdateSort($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id); // sponsored_student_sponsored_student_id
	...
	function ResetCmd() {
		...
		if (@$_GET["cmd"] <> "") {
			...
			if (strtolower($sCmd) == "resetsort") {
				...
				$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->setSort("");
	...
	function RenderRow() {
		...
		$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->CellCssStyle = ""; $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->CellCssClass = "";
		$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->CellAttrs = array(); $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->ViewAttrs = array(); $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->EditAttrs = array();
		...
		if ($view_sponsored_student_grant_package->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$view_sponsored_student_grant_package->start_date->ViewValue = ew_FormatDateTime($view_sponsored_student_grant_package->start_date->ViewValue, 7);
			...
			$view_sponsored_student_grant_package->end_date->ViewValue = ew_FormatDateTime($view_sponsored_student_grant_package->end_date->ViewValue, 7);
			...
			// sponsored_student_sponsored_student_id
			$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->ViewValue = $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->CurrentValue;
			$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->CssStyle = "";
			$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->CssClass = "";
			$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->ViewCustomAttributes = "";
			...
			// sponsored_student_sponsored_student_id
			$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->HrefValue = "";
			$view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->TooltipValue = "";
	...
	function ExportData() {
		...
		if ($view_sponsored_student_grant_package->Export == "xml") {
			...
			if ($ExportDoc->Horizontal) { // Horizontal format, write header
				...
				$ExportDoc->ExportCaption($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id);
		...
		while (!$rs->EOF && $this->lRecCnt < $this->lStopRec) {
			...
			if (intval($this->lRecCnt) >= intval($this->lStartRec)) {
				...
				if ($view_sponsored_student_grant_package->Export == "xml") {
					...
					$XmlDoc->AddField('sponsored_student_sponsored_student_id', $view_sponsored_student_grant_package->sponsored_student_sponsored_student_id->ExportValue($view_sponsored_student_grant_package->Export, $view_sponsored_student_grant_package->ExportOriginalValue));
					...
					$ExportDoc->ExportField($view_sponsored_student_grant_package->sponsored_student_sponsored_student_id);
