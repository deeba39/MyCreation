...
$RootMenu->AddMenuItem(13, $Language->MenuPhrase("13", "MenuText"), "sponsored_studentlist.php", -1, "", AllowListMenu('sponsored_student'));
$RootMenu->AddMenuItem(48, $Language->MenuPhrase("48", "MenuText"), "sponsored_student_detaillist.php?cmd=resetall", 13, "", AllowListMenu('sponsored_student_detail'));
$RootMenu->AddMenuItem(52, $Language->MenuPhrase("52", "MenuText"), "view_sponsored_student_gradelist.php", 13, "", AllowListMenu('view_sponsored_student_grade'));
...
$RootMenu->AddMenuItem(24, $Language->MenuPhrase("24", "MenuText"), "payment_requestlist.php", 30, "", AllowListMenu('payment_request'));
