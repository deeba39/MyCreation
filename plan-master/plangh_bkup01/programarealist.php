...
class cprogramarea_list {
	...
	function RenderListOptions() {
		...
		if ($Security->AllowList('community')) {
			...
			$oListOpt->Body = "<a href=\"communitylist.php?" . EW_TABLE_SHOW_MASTER . "=programarea&programarea_id=" . urlencode(strval($programarea->programarea_id->CurrentValue)) . "\">" . $oListOpt->Body . "</a>";
		}
