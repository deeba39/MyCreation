...
<form name="fsponsored_studentlistsrch" id="fsponsored_studentlistsrch" class="ewForm" action="<?php echo ew_CurrentPage() ?>">
...
<?php if ($sponsored_student->student_firstname->Visible) { // student_firstname ?>
	<?php if ($sponsored_student->SortUrl($sponsored_student->student_firstname) == "") { ?>
		<td><?php echo $sponsored_student->student_firstname->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($sponsored_student->student_middlename->Visible) { // student_middlename ?>
	<?php if ($sponsored_student->SortUrl($sponsored_student->student_middlename) == "") { ?>
		<td><?php echo $sponsored_student->student_middlename->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($sponsored_student->student_applicant_student_applicant_id->Visible) { // student_applicant_student_applicant_id ?>
	<?php if ($sponsored_student->SortUrl($sponsored_student->student_applicant_student_applicant_id) == "") { ?>
		<td><?php echo $sponsored_student->student_applicant_student_applicant_id->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($sponsored_student->student_resident_programarea_id->Visible) { // student_resident_programarea_id ?>
	<?php if ($sponsored_student->SortUrl($sponsored_student->student_resident_programarea_id) == "") { ?>
		<td><?php echo $sponsored_student->student_resident_programarea_id->FldCaption() ?></td>
	<?php } else { ?>
	...
	function ExportData() {
		...
		if ($sponsored_student->Export == "xml") {
			...
			if ($ExportDoc->Horizontal) { // Horizontal format, write header
				...
				$ExportDoc->ExportCaption($sponsored_student->student_picture);
				$ExportDoc->ExportCaption($sponsored_student->student_grades);
				...
				$ExportDoc->ExportCaption($sponsored_student->group_id);
		...
		while (!$rs->EOF && $this->lRecCnt < $this->lStopRec) {
			...
			if (intval($this->lRecCnt) >= intval($this->lStartRec)) {
				...
				if ($sponsored_student->Export == "xml") {
					...
					$XmlDoc->AddField('student_picture', $sponsored_student->student_picture->ExportValue($sponsored_student->Export, $sponsored_student->ExportOriginalValue));
					$XmlDoc->AddField('student_grades', $sponsored_student->student_grades->ExportValue($sponsored_student->Export, $sponsored_student->ExportOriginalValue));
					...
					$XmlDoc->AddField('group_id', $sponsored_student->group_id->ExportValue($sponsored_student->Export, $sponsored_student->ExportOriginalValue));
				} else {
					...
					$ExportDoc->ExportField($sponsored_student->student_picture);
					$ExportDoc->ExportField($sponsored_student->student_grades);
					...
					$ExportDoc->ExportField($sponsored_student->group_id);
					$ExportDoc->EndExportRow();
				}
			}
			$rs->MoveNext();
