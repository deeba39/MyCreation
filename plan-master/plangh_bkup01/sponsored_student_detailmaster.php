...
<table cellspacing="0" class="ewTable ewTableSeparate">
	<thead>
		<tr>
			...
			<td class="ewTableHeader"><?php echo $sponsored_student_detail->community_community_id->FldCaption() ?></td>
...
<div<?php echo $sponsored_student_detail->community_community_id->ViewAttributes() ?>><?php echo $sponsored_student_detail->community_community_id->ListViewValue() ?></div></td>
