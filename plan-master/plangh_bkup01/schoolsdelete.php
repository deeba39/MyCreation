...
<?php echo $schools->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		...
		<td valign="top"><?php echo $schools->community_community_id->FldCaption() ?></td>
...
<div<?php echo $schools->community_community_id->ViewAttributes() ?>><?php echo $schools->community_community_id->ListViewValue() ?></div></td>
